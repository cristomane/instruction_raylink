...
const platformsData: PlatformData[] = [
  {
    ...
    steps: [
      ...
      },
      {
        ...
        description: <>Скопируйте свой профиль в разделе <strong>👤 Мой профиль &gt; 🔗 Ссылка подключения</strong> в боте RayLink.</>,
        media: { type: 'image', src: 'media/ios/raylink_instruction_1.png', alt: 'Копирование профиля' },
        extraMedia: { type: 'image', src: 'media/ios/raylink_instruction_2.png', alt: 'Ссылка подключения' },
      },
      {
        number: '03',
        title: 'Импортируйте профиль',
        description: <>Откройте приложение INCY, нажмите <strong>«Вставить»</strong> и вставьте скопированную ссылку из бота.</>,
        media: { type: 'image', src: 'media/ios/raylink_instruction_3.png', alt: 'Импорт профиля' },
      },
      {
        number: '04',
        title: 'Подключитесь',
        description: 'Выберите добавленную конфигурацию и нажмите кнопку подключения. Готово!',
        media: { type: 'image', src: 'media/ios/raylink_instruction_4.png', alt: 'Подключение' },
      },
    ],
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        title: 'Получите конфигурацию',
        description: <>Скопируйте свой профиль в разделе <strong>👤 Мой профиль &gt; 🔗 Ссылка подключения</strong> в боте RayLink.</>,
        media: { type: 'image', src: 'media/android/raylink_instruction_1.png', alt: 'Копирование профиля' },
        extraMedia: { type: 'image', src: 'media/android/raylink_instruction_2.png', alt: 'Ссылка подключения' },
      },
      {
        number: '03',
        title: 'Импортируйте профиль',
        description: <>Откройте приложение INCY, нажмите <strong>«Вставить»</strong> и вставьте скопированную ссылку из бота.</>,
        media: { type: 'image', src: 'media/android/raylink_instruction_3.png', alt: 'Импорт профиля' },
      },
      {
        number: '04',
        title: 'Подключитесь',
        description: 'Выберите добавленную конфигурацию и нажмите кнопку подключения. Готово!',
        media: { type: 'image', src: 'media/android/raylink_instruction_4.png', alt: 'Подключение' },
      },
    ],
  },
  {
